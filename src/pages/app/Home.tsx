...
import { HighestOpportunityCard } from "@/components/atlas/HighestOpportunityCard";
...
export default function Home() {
  ...
  return (
    <div className="relative page-hero mx-auto max-w-2xl px-6 py-10 md:py-16 animate-fade-in space-y-8">
      ...
      {/* ── Founder Brief: Highest-Probability Opportunity ─────────────── */}
      <HighestOpportunityCard />

      {/* ── Daily 22-Touch Operating System ────────────────────────────── */}
      <DailyOsTracker />
